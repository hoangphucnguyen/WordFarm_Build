...
namespace GameFramework.Localisation.Components
{
	...
	[AddComponentMenu("Game Framework/Localisation/Localise Text Format")]
	[HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/localisation/")]
	public class LocaliseTextFormat : RunOnMessage<LocalisationChangedMessage>
	{
		/// <summary>
		/// Localization key.
		/// </summary>
		...
		void OnLocalise()
		{
			...
			if (!string.IsNullOrEmpty(Key)) Value = Localisation.LocaliseText.Format (Key, format);
