...
namespace GameFramework.Preferences.PrefsEditorIntegration
{
	...
	/// </summary>
	public class PrefsEditorJSONHandler : IPreferences
	{
		/// <summary>
		...
		public bool UseSecurePrefs {
			get { return SecurePlayerJSONPrefs.UseSecurePrefs; }
			set { SecurePlayerJSONPrefs.UseSecurePrefs = value; }
		}
		...
		{
			get { return SecurePlayerJSONPrefs.AutoConvertUnsecurePrefs; }
			set { SecurePlayerJSONPrefs.AutoConvertUnsecurePrefs = value; }
		}
		...
		{
			set { SecurePlayerJSONPrefs.PassPhrase = value; }
		}
		...
		{
			SecurePlayerJSONPrefs.SetFloat(key, value, useSecurePrefs);
		}
