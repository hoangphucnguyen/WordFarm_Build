...
namespace ProPooling._Demo
{
    ...
    public class AutoReturnToPoolSpawner : MonoBehaviour
    {
        ...
        void Start()
        {
            _pool = PoolManager.Instance.GetPool("Particles");
        }
        ...
        void Update()
        {
            ...
            {
                _pool.GetPoolItemFromPool(new Vector3(Random.Range(-2, 2), Random.Range(-2, 2)), Quaternion.identity, transform);
