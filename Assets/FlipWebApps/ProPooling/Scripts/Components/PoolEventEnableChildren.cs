...
namespace ProPooling.Components
{
    ...
    /// </summary>
    [AddComponentMenu("ProPooling/PoolEventEnableChildren")]
    [HelpURL("http://www.flipwebapps.com/pro-pooling/")]
    public class PoolEventEnableChildren : MonoBehaviour, IPoolComponent
    {
        #region IPoolComponent

        /// <summary>
        /// Activate all child gameobjects when pulled from a pool
        /// </summary>
