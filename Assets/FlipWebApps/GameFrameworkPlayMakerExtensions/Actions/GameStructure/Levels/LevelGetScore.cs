...
{
    /// <summary>
    /// Get the score for the current level into a playmaker variable.
    /// </summary>
    [ActionCategory("Game Framework")]
    [Tooltip("Get the score for the current level into a playmaker variable.")]
    public class LevelGetScore : FsmStateAction
    {
        /// <summary>
        /// Variable to which to copy the level score.
        /// </summary>
        [Tooltip("Variable to which to copy the level score.")]
        ...
        void PerformAction()
        {
            ...
            Score.Value = LevelManager.Instance.Level.Score;
        }
    }
}
#endif